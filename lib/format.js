...
// whole file is probeable with plain qml6 (see test/probe_format.qml).
.pragma library

// Empty cell marker in SDK matrix maps (0xFFFFFFFF).
var MATRIX_EMPTY = 4294967295;

// Defuse server-provided strings before they reach components we don't
// control (shell Button/Dropdown set no textFormat, so Qt's AutoText could
// interpret markup in a hostile device or profile name).
function plain(s) {
